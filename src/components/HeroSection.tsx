...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div ref={contentRef} className="container-industrial relative z-10 pt-20">
        <div className="max-w-3xl">
          ...
          <p className="hero-subtitle text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-xl leading-relaxed">
            From concept to production, we deliver excellence in mechanical engineering, custom fabrication, and industry-leading training programs.
          </p>
          <div className="hero-buttons flex flex-col sm:flex-row gap-4">
            ...
            <Button
              ...
              className="border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground/10 font-semibold px-8 py-6 text-base"
            >
              View Courses
            </Button>
          </div>
