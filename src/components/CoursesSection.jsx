...
const courses = [
  {
    ...
    description:
      "Master the essentials of CNC programming, setup, and operation. Hands-on training with real machinery.",
    featured: false,
  },
  {
    ...
    description:
      "Deep dive into multi-axis machining, advanced materials, and precision tolerancing techniques.",
    featured: true,
  },
  {
    ...
    description:
      "Learn CMM operation, GD&T interpretation, and statistical process control methodologies.",
    featured: false,
  },
  {
    ...
    description:
      "Comprehensive training in SolidWorks, Mastercam, and Fusion 360 for manufacturing applications.",
    featured: false,
  },
];
...
export const CoursesSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="courses"
      className="section-padding bg-industrial-gradient"
    >
      <div className="container-industrial">
        <div className="courses-header text-center mb-16">
          ...
          <p className="text-primary-foreground/80 max-w-2xl mx-auto text-lg">
            Invest in your skills with hands-on training programs designed by
            industry experts. Our courses prepare you for real-world
